...
class GlobalAttention(nn.Module):
    """
    Global attention takes a matrix and a query vector. It then computes a parameterized convex combination of the matrix
    ...
    * Bahdanau Attention (mlp):
    ...
    Args:
       dim (int): dimensionality of query and key coverage (bool): use coverage term
...
class MultiHeadedAttention(nn.Module):
    ...
    "Attention is All You Need" :cite:`DBLP:journals/corr/VaswaniSPUJGKP17`.
    ...
    """
    def __init__(self, head_count, model_dim, dropout=0.1, use_final_linear=True, need_distribution=False):
