...
class TransformerDecoderLayer(nn.Module):
    ...
    Args:
      ...
      d_ff (int): the second-layer of the Positionwise_FeedForward.
    ...
    def __init__(self, d_model, heads, d_ff, dropout):
        ...
        # Register self.mask as a buffer in TransformerDecoderLayer,
        # so it gets TransformerDecoderLayer's cuda behavior.
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None, step=None, cache=None,memory_masks=None, need_y_emb = False):
        """
