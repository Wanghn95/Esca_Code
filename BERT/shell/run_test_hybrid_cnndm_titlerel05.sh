...
--hybrid_loss \
-test_batch_size 500 \
-test_from /home/hnwang/ACL2020/BERT/model_step_22000.pt \
-bert_data_path /home/hnwang/ACL2020/New_title_data/bert_data/cnndm \
-log_file ../logs/val_hybrid_bert_cnndm_hyconnect_title_05.log \
...
-result_path ../results/hybrid_bert_cnndm_hyconnect_title/hyconnect05
